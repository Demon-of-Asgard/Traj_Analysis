...
bin_polated binterpole(double time, double x, double z){
	...
	if(bin_number==18){
		...
		double Nnu50Theta_t = Nnu50Theta1_t;
		double Enu50Theta_t = Enu50Theta1_t;
		//==================================================================================================================================
		...
		double Nnu100Theta_t = Nnu100Theta1_t;
		double Enu100Theta_t = Enu100Theta1_t;
		...
		double Nanu50Theta_t = Nanu50Theta1_t;
		double Eanu50Theta_t = Eanu50Theta1_t;
		//=================================================================================================================================
		...
		double Nanu100Theta_t = Nanu100Theta1_t;
		double Eanu100Theta_t = Eanu100Theta1_t;
		//==================================================================================================================================
