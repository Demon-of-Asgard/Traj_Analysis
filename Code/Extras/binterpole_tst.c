...
//#include "Libs.h"
#include "Global.h"
#include "shape_of_file.h"
#include "Interpolation_subroutines.h"
...
int main(){
	...
	//printf("theta = %le\tthetabin1=%le\tthetabin2=%le\tbin_number = %d\n\v",theta*(180.0/M_PI), thetabin1*(180.0/M_PI),thetabin2*(180.0/M_PI),bin_number);

	int row_number = 0;
	for(int i=0;Lnu50[i][0]<time;i++){
		row_number = i;
	}
	...
	//printf("DA50=%le\tDA100=%le\n\v", Delta_A50, Delta_A100);
	...
	// printf("Lnu50=%le\tavEnu50=%le\n",Lnu50[row_number][bin_number],avEnu50[row_number][bin_number]);
	// printf("Nnu50Theta1_t1 = %le\n",Nnu50Theta1_t1);
	// printf("Nnu50Theta1_t2 = %le\n",Nnu50Theta1_t2);
	// printf("Nnu50Theta1_t=%le\n\v",Nnu50Theta1_t);
	...
	// printf("Nnu50Theta2_t1 = %le\n",Nnu50Theta2_t1);
	// printf("Nnu50Theta2_t2 = %le\n",Nnu50Theta2_t2);
	// printf("Nnu50Theta2_t=%le\n\v",Nnu50Theta2_t);

	double Nnu50Theta_t = NewtonsInterpolation(theta, thetabin1, thetabin2, Nnu50Theta1_t, Nnu50Theta2_t);
	...
	// printf("Lnu100=%le\tavEnu100=%le\n",Lnu100[row_number][bin_number],avEnu100[row_number][bin_number]);
	// printf("Nnu100Theta1_t1 = %le\n",Nnu100Theta1_t1);
	// printf("Nnu100Theta1_t2 = %le\n",Nnu100Theta1_t2);
	// printf("Nnu100Theta1_t=%le\n\v",Nnu100Theta1_t);
	...
	// printf("Nnu100Theta2_t1 = %le\n",Nnu100Theta2_t1);
	// printf("Nnu100Theta2_t2 = %le\n",Nnu100Theta2_t2);
	// printf("Nnu100Theta2_t  = %le\n\v",Nnu100Theta2_t);

	double Nnu100Theta_t = NewtonsInterpolation(theta, thetabin1, thetabin2, Nnu100Theta1_t, Nnu100Theta2_t);
	//printf("Nnu100Theta_t = %le\n\v", Nnu100Theta_t);

	double NnuTheta_rt = NewtonsInterpolation(r,r50,r100,Nnu50Theta_t, Nnu100Theta_t);
